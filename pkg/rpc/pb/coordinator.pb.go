...
func (x *SubmitJobRequest) GetNReduce() int32 {
	if x != nil {
		return x.NReduce
	}
	return 0
...
const file_coordinator_proto_rawDesc = "" +
	...
	"\vCoordinator\x12F\n" +
	"\tSubmitJob\x12\x1b.rpc.proto.SubmitJobRequest\x1a\x1c.rpc.proto.SubmitJobResponseB\x1cZ\x1amapreduce/pkg/rpc/pb;rpcpbb\x06proto3"
...
var file_coordinator_proto_goTypes = []any{
	(*SubmitJobRequest)(nil),  // 0: rpc.proto.SubmitJobRequest
	(*SubmitJobResponse)(nil), // 1: rpc.proto.SubmitJobResponse
}
var file_coordinator_proto_depIdxs = []int32{
	0, // 0: rpc.proto.Coordinator.SubmitJob:input_type -> rpc.proto.SubmitJobRequest
	1, // 1: rpc.proto.Coordinator.SubmitJob:output_type -> rpc.proto.SubmitJobResponse
